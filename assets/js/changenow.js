! function(e) {
  ...
  function p(e, t) {
              ...
              switch (e.arrayFormat) {
                  ...
                  case "separator":
                      return (t, r, n) => {
                          const o = "string" == typeof r && r.includes(e.arrayFormatSeparator),
                              a = "string" == typeof r && !o && d(r, e).includes(e.arrayFormatSeparator);
                          r = a ? d(r, e) : r;
                          const i = o || a ? r.split(e.arrayFormatSeparator).map(t => d(t, e)) : null === r ? r : d(r, e);
                          n[t] = i
                      };
                  case "bracket-separator":
                      return (t, r, n) => {
                          ...
                          const a = null === r ? [] : r.split(e.arrayFormatSeparator).map(t => d(t, e));
      ...
      for (const e of Object.keys(n)) {
          ...
          if ("object" == typeof r && null !== r)
              for (const e of Object.keys(r)) r[e] = m(r[e], t);
          else n[e] = m(r, t)
      }
  ...
  t.extract = f, t.parse = p, t.stringify = (e, t) => {
      if (!e) return "";
      u((t = Object.assign({
          encode: !0,
          strict: !0,
      ...
      return !1 !== t.sort && a.sort(t.sort), a.map(r => {
          const o = e[r];
          return void 0 === o ? "" : null === o ? c(r, t) : Array.isArray(o) ? 0 === o.length && "bracket-separator" === t.arrayFormat ? c(r, t) + "[]" : o.reduce(n(r), []).join("&") : c(r, t) + "=" + c(o, t)
      ...
      return e.fragmentIdentifier && (d = "#" + (r[s] ? c(e.fragmentIdentifier, r) : e.fragmentIdentifier)), `${n}${u}${d}`
  }, t.pick = (e, r, n) => {
      n = Object.assign({
  ...
  e.exports = {
      ...
      API_KEY: "07c68a80cc1582087df7509f51a8a8b29eb5ec3f13db8c40a7633c6b1801b832",
      DEFAULT_FIAT: "eur",
  ...
  function m(e) {
      return function(t) {
          ...
          var i, s = a[0],
              ...
              c = Array.isArray(u) ? h(u, (function(e) {
                  return e.test(s)
              })) : p(u, (function(e) {
                  return e.test(s)
              }));
  ...
  var y = function(e) {
      ...
      b = function(e) {
          ...
          return decodeURI(e).split(t).map((function(e) {
              return y(e.trim())
          }))
      },
      v = r(3);
  ...
  var F = function(e) {
          var t = {};
          e && "string" == typeof e && e.slice(1, e.length).split("&").forEach((function(e) {
              var r = e.split("="),
                  n = o()(r, 2),
                  a = n[0],
                  i = n[1],
                  s = escape(i);
              if ("undefined" !== s && "" !== s) switch (a) {
                  case "from":
                      t.fromTicker = s;
                      break;
                  case "to":
  ...
  if (x) {
      ...
      x.src = "".concat("https://changenow.io/embeds/exchange-widget/v2/widget.html", "?").concat(Z)
  }
  window.addEventListener("message", (function(e) {
      ...
      if ("Open modal" === e.data.messageText) {
          ...
          o.className = "wrapper-iframe", o.style.cssText = "\n      position: fixed;\n      top: 0;\n      right: 0;\n      left: 0;\n      bottom: 0;\n      height: 100vh;\n      width: 100vw;\n      z-index: 10000000000;\n    ", window.document.body.appendChild(o);
          ...
          n.src = "".concat("https://changenow.io/embeds/exchange-widget/v2/stepper.html", "?").concat(i), n.style.cssText = "width: 100%; height: 100%; border: none", n.id = "iframe-stepper", n.allow = "camera *", o.appendChild(n)
      }
  }), !1)
}]);